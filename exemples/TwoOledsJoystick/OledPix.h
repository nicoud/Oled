//\prog:OledPix.h  version du 170522
//#include <avr.IO.h> en C sur avr
//===============
...
const uint8_t taMaj[] PROGMEM = {
  ...
  0x00,0x41,0x41,0x7f,0x00, 0x04,0x02,0x01,0x02,0x04, // ] ^ ?? pas affiché
